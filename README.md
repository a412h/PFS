...
#### Grid with 1 061 208 dofs, with a laptop card RTX4070, simulation setup in fp32
     (fp64 and fp32 implemented, fp32 is used here as it runs much faster on this type of card, and fp64 would be too large), T=5.0, dt=0.05, I get a computation time of about an hour):
